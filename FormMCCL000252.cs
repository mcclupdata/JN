...
namespace MC
{
    public partial class FormMCCL000252 : Formbase
    {
        clswpsEdit _cls;
        ...
        protected void loadweldEquipmentTask()
        {
            ...
            col = new DataColumn(); col.ColumnName = "SFSTARTTIME"; col.DataType = typeof(String); dtf.Columns.Add(col);
            col = new DataColumn(); col.ColumnName = "SFENDTIME"; col.DataType = typeof(String); dtf.Columns.Add(col);
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            //增加开始时间和结束时间
            DataColumn col = new DataColumn(); col.ColumnName = "sFSTARTTIME"; col.DataType = typeof(String); fdt.Columns.Add(col);
            col = new DataColumn(); col.ColumnName = "sFENDTIME"; col.DataType = typeof(String); fdt.Columns.Add(col);
